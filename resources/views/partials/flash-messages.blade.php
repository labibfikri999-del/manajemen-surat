...
@if(session('warning'))
    <div class="mb-4 p-4 bg-yellow-100 border border-yellow-300 text-yellow-700 rounded-lg flex items-center gap-2 animate-fade-in">
...
@if(session('info'))
    <div class="mb-4 p-4 bg-blue-100 border border-blue-300 text-blue-700 rounded-lg flex items-center gap-2 animate-fade-in">
