            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                <form action="{{ route('buat-surat.store') }}" method="POST" class="p-8 space-y-8">
                    ...
                    <div class="flex items-center justify-end gap-3 pt-6 mt-6 border-t border-gray-200">
                        ...
                        <button type="submit" formaction="{{ route('buat-surat.download-word') }}" formtarget="_blank" class="btn bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-blue-500/30">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            Download Word
                        </button>

                        <button type="submit" class="btn btn-primary px-6 py-2 shadow-lg hover:shadow-emerald-500/30">
