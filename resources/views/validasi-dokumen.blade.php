                                ...
                                <div class="p-4 hover:bg-gray-50">
                                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                        ...
                                        <div class="flex gap-2">
                                            @if($dok->file_path)
                                                <button onclick="showPreviewModal('{{ \Illuminate\Support\Facades\Storage::url($dok->file_path) }}', '{{ addslashes($dok->judul) }}', '{{ strtolower(pathinfo($dok->file_path, PATHINFO_EXTENSION)) }}')"
                                            ...
                                            @endif
                                            <button onclick="showValidasiModal({{ $dok->id }}, '{{ addslashes($dok->judul) }}')" 
