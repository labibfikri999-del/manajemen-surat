...
<body class="bg-gray-50">
    ...
    {{-- Modal Validasi --}}
    <div id="validasiModal" class="fixed inset-0 bg-black/60 backdrop-blur-sm hidden items-end sm:items-center justify-center z-50 p-4 transition-all duration-300">
        <div class="bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl w-full max-w-xl mx-auto transform transition-all scale-100">
            ...
            <form id="validasiForm">
                ...
                <div class="p-6 space-y-6">
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="relative flex flex-col items-center p-4 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-red-200 hover:bg-red-50 transition-all group">
                                <input type="radio" name="status" value="ditolak" class="peer sr-only" onchange="toggleSignatureArea(this.value)">
                                <div class="w-10 h-10 rounded-full bg-red-100 text-red-600 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform peer-checked:bg-red-600 peer-checked:text-white">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                                </div>
                                <span class="font-medium text-gray-700 peer-checked:text-red-700">Tolak Dokumen</span>
                            </label>

                            <label class="relative flex flex-col items-center p-4 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-emerald-200 hover:bg-emerald-50 transition-all group">
                                <input type="radio" name="status" value="disetujui" class="peer sr-only" required onchange="toggleSignatureArea(this.value)">
                                <div class="w-10 h-10 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center mb-2 group-hover:scale-110 transition-transform peer-checked:bg-emerald-600 peer-checked:text-white">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg>
                                </div>
                                <span class="font-medium text-gray-700 peer-checked:text-emerald-700">Setujui Dokumen</span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="p-6 border-t bg-gray-50 flex gap-3 justify-end rounded-b-2xl sm:rounded-b-2xl">
    ...
    <script>
        ...
        function toggleSignatureArea(value) {
            ...
            if (value === 'disetujui') {
                ...
                // Re-init/Resize canvas when becoming visible
                setTimeout(() => {
                    initSignaturePad();
                }, 100);
            } else {
