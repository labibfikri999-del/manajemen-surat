...
@php
    ...
    $menus = [
        [
            ...
            'roles' => ['direktur', 'staff', 'instansi', 'admin'], // Semua bisa akses
        ],
        [
            'name' => 'Upload Dokumen',
        ...
        [
            ...
            'roles' => ['direktur', 'staff', 'instansi', 'admin'],
        ],
        [
            'name' => 'Arsip Digital',
            'route' => 'arsip-digital',
