...
<body class="bg-emerald-50">
  <div id="app" class="flex flex-col">
      ...
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 mb-6">
          <div class="bg-white rounded-lg shadow p-3 md:p-4">
            ...
            <p class="text-2xl md:text-3xl font-bold text-emerald-900 mt-2">{{ $totalArsip ?? 0 }}</p>
          ...
          <div class="bg-white rounded-lg shadow p-3 md:p-4">
            ...
            <p class="text-2xl md:text-3xl font-bold text-emerald-900 mt-2">{{ $totalSize ?? '0 B' }}</p>
          ...
          <div class="bg-white rounded-lg shadow p-3 md:p-4">
            ...
            <p class="text-lg md:text-xl font-bold text-emerald-900 mt-2">
              @if(!empty($lastAccess))
    ...
    {{-- Toast Notification --}}
    <div id="toast" class="hidden fixed top-20 right-4 z-[9999] transform transition-all duration-300 ease-out">
