    ...
    <div x-data="{ sidebarOpen: window.innerWidth >= 768 }" class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0 w-64' : '-translate-x-full md:translate-x-0 md:w-20'" class="glass-sidebar flex flex-col transition-all duration-300 fixed md:relative z-30 h-full shadow-xl shadow-fuchsia-100/20">
            ...
            <nav class="flex-1 overflow-y-auto py-6 space-y-1">
                ...
                <!-- Absensi -->
                <a href="{{ route('pegawai.absensi.index') }}" class="{{ request()->routeIs('pegawai.absensi.*') ? 'nav-item-active' : 'text-slate-500 hover:text-fuchsia-600 hover:bg-fuchsia-50' }} flex items-center px-6 py-3.5 text-sm font-medium transition-all duration-200 group">
                ...
                <!-- Cuti / Ijin -->
                <a href="{{ route('pegawai.cuti.index') }}" class="{{ request()->routeIs('pegawai.cuti.*') ? 'nav-item-active' : 'text-slate-500 hover:text-fuchsia-600 hover:bg-fuchsia-50' }} flex items-center px-6 py-3.5 text-sm font-medium transition-all duration-200 group">
                ...
                <!-- Slip Gaji -->
                <a href="{{ route('pegawai.gaji.index') }}" class="{{ request()->routeIs('pegawai.gaji.*') ? 'nav-item-active' : 'text-slate-500 hover:text-fuchsia-600 hover:bg-fuchsia-50' }} flex items-center px-6 py-3.5 text-sm font-medium transition-all duration-200 group">
                ...
                <!-- Profil -->
                <a href="{{ route('pegawai.profile.index') }}" class="{{ request()->routeIs('pegawai.profile.index') ? 'nav-item-active' : 'text-slate-500 hover:text-fuchsia-600 hover:bg-fuchsia-50' }} flex items-center px-6 py-3.5 text-sm font-medium transition-all duration-200 group">
