...
<head>
    ...
    <title>Portal INKESYARSI - YARSI NTB</title>
...
<body class="antialiased text-slate-800 min-h-screen relative flex flex-col items-center justify-center py-12 px-4">
    ...
    <div class="fixed inset-0 w-full h-full -z-10 pointer-events-none overflow-hidden">
        ...
        <div class="absolute -bottom-32 left-20 w-96 h-96 bg-lime-300 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-4000"></div>
    </div>
    ...
    <main class="w-full max-w-5xl">
        ...
        <div class="text-center mb-16 relative">
            ...
            <!-- Left Decoration -->
            <img src="{{ asset('images/nav_decoration_left.png') }}" class="absolute -left-20 top-1/2 transform -translate-y-1/2 w-32 md:w-48 opacity-80 animate-float hidden lg:block pointer-events-none mix-blend-multiply" alt="">
            
            <!-- Left Aurora / Orb -->
            <div class="absolute top-1/2 -left-20 md:-left-32 transform -translate-y-1/2 w-48 md:w-64 h-48 md:h-64 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob pointer-events-none hidden lg:block"></div>

            <!-- Right Aurora / Orb -->
            <div class="absolute top-1/2 -right-20 md:-right-32 transform -translate-y-1/2 w-48 md:w-64 h-48 md:h-64 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-40 animate-blob animation-delay-2000 pointer-events-none hidden lg:block"></div>


            <!-- Right Decoration -->
            <img src="{{ asset('images/nav_decoration_right.png') }}" class="absolute -right-20 top-1/2 transform -translate-y-1/2 w-32 md:w-48 opacity-80 animate-float-delayed hidden lg:block pointer-events-none mix-blend-multiply" alt="">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <a href="{{ route('login') }}" class="glass-panel rounded-3xl p-6 relative overflow-hidden group card-hover text-center border-2 border-transparent hover:border-emerald-200 flex flex-col justify-center items-center">
                ...
                <span class="inline-block px-5 py-1.5 rounded-full bg-emerald-100 text-emerald-700 text-xs font-bold group-hover:bg-emerald-600 group-hover:text-white transition-all">
                    Akses Masuk →
                </span>
            </a>

            <!-- Card 2: SDM (Renamed from HRD) -->
            <a href="#" class="glass-panel rounded-3xl p-6 relative overflow-hidden group card-hover text-center border-2 border-transparent hover:border-cyan-200 flex flex-col justify-center items-center">
                ...
                <p class="text-slate-500 text-xs text-balance">Sumber Daya Manusia</p>
            </a>

            <!-- Card 3: Keuangan (New) -->
            <a href="#" class="glass-panel rounded-3xl p-6 relative overflow-hidden group card-hover text-center border-2 border-transparent hover:border-amber-200 flex flex-col justify-center items-center">
                ...
                <p class="text-slate-500 text-xs text-balance">Manajemen Finansial</p>
            </a>

            <!-- Card 4: Pegawai (New) -->
            <a href="#" class="glass-panel rounded-3xl p-6 relative overflow-hidden group card-hover text-center border-2 border-transparent hover:border-purple-200 flex flex-col justify-center items-center">
                ...
                <p class="text-slate-500 text-xs text-balance">Portal Layanan Staff</p>
            </a>

            <!-- Card 5: Aset (Existing) -->
            <a href="#" class="glass-panel rounded-3xl p-6 relative overflow-hidden group card-hover text-center border-2 border-transparent hover:border-lime-200 flex flex-col justify-center items-center">
                ...
                <p class="text-slate-500 text-xs text-balance">Inventaris & Logistik</p>
            </a>
