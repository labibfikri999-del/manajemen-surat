...
<body class="bg-gray-50 text-slate-800 font-sans antialiased">
    <div x-data="{ sidebarOpen: true }" class="flex h-screen overflow-hidden">
        ...
        <!-- Sidebar -->
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="glass-sidebar flex flex-col transition-all duration-300 fixed md:relative z-30 h-full">
            <!-- Brand -->
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 p-4 md:p-8 relative">
            ...
            <button @click="sidebarOpen = !sidebarOpen" class="absolute top-4 left-4 md:hidden p-2 rounded-lg bg-white shadow-sm text-slate-600">
