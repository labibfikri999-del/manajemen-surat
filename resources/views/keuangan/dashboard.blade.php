...
<div class="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-3xl font-bold text-slate-800 tracking-tight">Financial Dashboard</h1>
            <p class="text-slate-500">Ringkasan kesehatan keuangan rumah sakit & operasional.</p>
        </div>
        <div class="flex gap-3">
            <a href="{{ route('keuangan.budget.index') }}" class="bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-amber-600 px-5 py-2.5 rounded-xl font-bold text-sm transition-all flex items-center gap-2">
