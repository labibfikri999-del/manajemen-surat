...
<head>
  ...
  <title>Surat Keluar — Arsiparis</title>
...
<body class="bg-sky-50">
  <div id="app" class="flex flex-col">
    <header class="site-header bg-white border-b border-sky-100 flex items-center justify-between px-4 md:px-6 lg:px-8 shadow-sm">
      ...
      <div class="text-sm text-sky-600">Surat Keluar</div>
    </header>
    ...
    <main id="main" class="transition-smooth main-with-sidebar flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto">
      <div class="max-w-7xl mx-auto">
        <div class="mb-6">
          <h1 class="text-3xl font-bold text-sky-900">Surat Keluar</h1>
          <p class="text-sky-600 mt-2">Kelola semua surat yang keluar dari instansi</p>
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 mb-6">
          <div class="bg-white rounded-lg shadow p-3 md:p-4">
            <div class="text-sky-600 text-xs md:text-sm font-medium">Total Surat Keluar</div>
            <p class="text-2xl md:text-3xl font-bold text-sky-900 mt-2">87</p>
            <p class="text-xs text-sky-500 mt-1">Tahun ini</p>
          </div>
          <div class="bg-white rounded-lg shadow p-3 md:p-4">
            <div class="text-sky-600 text-xs md:text-sm font-medium">Siap Dikirim</div>
            <p class="text-2xl md:text-3xl font-bold text-orange-600 mt-2">5</p>
            <p class="text-xs text-sky-500 mt-1">Menunggu</p>
          </div>
          <div class="bg-white rounded-lg shadow p-3 md:p-4">
            <div class="text-sky-600 text-xs md:text-sm font-medium">Sudah Dikirim</div>
        ...
        <div class="flex flex-col sm:flex-row flex-wrap gap-3 mb-6">
          ...
          <button id="btnCetak" class="border border-sky-300 text-sky-700 px-4 py-2 rounded hover:bg-sky-50 flex items-center justify-center gap-2" aria-label="Cetak Daftar Surat Keluar">
          ...
          <input id="searchInput" type="text" placeholder="Cari surat..." class="flex-1 sm:flex-initial sm:ml-auto px-4 py-2 border border-sky-300 rounded focus:outline-none focus:border-sky-500" aria-label="Cari surat keluar" />
        </div>
            ...
            <table class="w-full">
              <thead class="bg-sky-50 border-b border-sky-100">
                <tr>
                  ...
                  <th class="px-6 py-3 text-left text-sm font-semibold text-sky-900">Tanggal Dibuat</th>
                  <th class="px-6 py-3 text-left text-sm font-semibold text-sky-900">Tujuan</th>
              ...
              <tbody id="tableBody" class="divide-y divide-sky-100">
                ...
                <tr class="animate-pulse skeleton-row">
                  ...
                  <td class="px-6 py-4"><div class="h-5 bg-sky-200 rounded w-20"></div></td>
        ...
        <div class="flex items-center justify-between mt-6">
          <p class="text-sm text-sky-600">Menampilkan 1 dari 87 surat keluar</p>
    ...
    <div id="modalForm" class="hidden fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-2xl z-50 w-full max-w-lg mx-4 transition-all duration-200 max-h-[90vh] overflow-y-auto">
      <div class="p-6">
        <div class="flex items-center justify-between mb-6">
          <h2 id="modalTitle" class="text-2xl font-bold text-sky-900">Tambah Surat Keluar</h2>
        ...
        <form id="suratForm" class="space-y-4" enctype="multipart/form-data">
          <div>
            ...
            <input type="text" id="formNomorSurat" placeholder="SK-2025/001" required class="w-full px-4 py-2 border border-sky-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent">
          </div>
          
          <div>
            <label class="block text-sm font-medium text-sky-700 mb-2">Tanggal Keluar <span class="text-red-500">*</span></label>
          ...
          <div>
            <label class="block text-sm font-medium text-sky-700 mb-2">Tujuan <span class="text-red-500">*</span></label>
            <input type="text" id="formTujuan" placeholder="Nama Tujuan" required class="w-full px-4 py-2 border border-sky-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent">
          </div>
    ...
    function renderTable() {
      ...
      allRowsData.forEach((item, index) => {
        ...
        row.innerHTML = `
          ...
          <td class="px-6 py-4"><span class="text-sky-600">${item.tanggal_keluar}</span></td>
          <td class="px-6 py-4"><span class="text-sky-600">${item.tujuan}</span></td>
          ...
          <td class="px-6 py-4 text-right">
            <button class="inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-white bg-sky-600 rounded-lg hover:bg-sky-700 transition btn-edit">
