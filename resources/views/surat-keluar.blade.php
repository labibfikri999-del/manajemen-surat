            ...
            <table class="w-full">
              <thead class="bg-emerald-50 border-b border-emerald-100">
                <tr>
                  ...
                  <th class="px-6 py-3 text-left text-sm font-semibold text-emerald-900">Tanggal Dibuat</th>
                  <th class="px-6 py-3 text-left text-sm font-semibold text-emerald-900">Tujuan</th>
